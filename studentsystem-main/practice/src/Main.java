...
//判断是选择的什么功能以及是否输入了错误
           switch (i) {
               case "1":
                   student.addstudy(list); // 增加学生功能
                   break;
               case "2":
                   student.deletestudy(list); // 删除学生功能
                   break;
               case "3":
                   student.modifystudy(list); // 修改学生功能
                   break;
               case "4":
                   student.querystudy(list); // 查询学生功能
                   break;
               case "5":
                   Coursesystem.Coursesystem(list); // 成绩系统
                   break;
               case "6":
                   ...
                   break loop;
               default:
                   System.out.println("输入错误，请选择正确功能！！");
                   break;
           }
           /* //版本高 下载下来不能用 用上面的
           switch (i) {
